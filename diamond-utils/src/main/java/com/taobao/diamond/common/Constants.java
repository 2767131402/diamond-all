...
public class Constants {
    ...
    public static String HTTP_URI_LOGIN = "/diamond-server";
    ...
    public static void init() {
        // 将配置文件 写到  System.getProperty("user.home") + CONFIG_HTTP_URI_FILE  这个目录下
        File diamondFile = new File(System.getProperty("user.home") + CONFIG_HTTP_URI_FILE, "ServerAddress");
        ...
        setValue(old, "CONFIG_HTTP_URI_FILE", "CONFIG_HTTP_URI_FILE");
        setValue(old, "HTTP_URI_LOGIN", "HTTP_URI_LOGIN");
